...
public class LinuxHostController {
    ...
    @RequiresPermissions("ops:linuxhost:page")
    ...
    @RequiresPermissions("ops:linuxhost:info")
    ...
    @LogOperation("保存")
    @RequiresPermissions("ops:linuxhost:save")
    ...
    @LogOperation("修改")
    @RequiresPermissions("ops:linuxhost:update")
    ...
    @LogOperation("导入")
    @RequiresPermissions("ops:linuxhost:import")
    ...
    @LogOperation("导入模板")
    @RequiresPermissions("ops:linuxhost:template")
    ...
    @LogOperation("删除")
    @RequiresPermissions("ops:linuxhost:delete")
    ...
    @LogOperation("导出")
    @RequiresPermissions("ops:linuxhost:export")
