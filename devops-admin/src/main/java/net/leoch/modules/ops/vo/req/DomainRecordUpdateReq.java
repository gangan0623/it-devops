 ...
 */
@Data
@Schema(name = "DomainRecordUpdateReq")
public class DomainRecordUpdateReq implements Serializable {
    @Serial
    ...
    @Data
    @Schema(name = "DomainRecordUpdateReq.DeliveryReq")
    ...
    @Data
    @Schema(name = "DomainRecordUpdateReq.DnsInternalReq")
    ...
    @Data
    @Schema(name = "DomainRecordUpdateReq.DnsExternalReq")
    ...
    @Data
    @Schema(name = "DomainRecordUpdateReq.FirewallMappingReq")
