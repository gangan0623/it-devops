package net.leoch.common.integration.excel;
 ...
 * 域名记录导出（支持节点池多行合并单元格）
 * <p>
 * 通过 index 保证与 DomainRecordImportExcel 列位置一致，导出可直接再导入。
 *
 * 列布局（共32列）：
 *   0-10  基础信息
 *   11-13 高级策略
...
@Data
@ContentRowHeight(18)
public class DomainRecordExcel {
    ...
    @ExcelProperty(value = "状态", index = 5, converter = net.leoch.common.integration.excel.converter.EnabledConverter.class)
    @ColumnWidth(10)
    ...
    @ExcelProperty(value = "走应用交付", index = 11, converter = net.leoch.common.integration.excel.converter.YesNoConverter.class)
    @ColumnWidth(12)
    private Integer adEnabled;

    @ExcelProperty(value = "开启内网配置", index = 12, converter = net.leoch.common.integration.excel.converter.YesNoConverter.class)
    @ColumnWidth(12)
    private Integer internalEnabled;

    @ExcelProperty(value = "开启公网配置", index = 13, converter = net.leoch.common.integration.excel.converter.YesNoConverter.class)
    @ColumnWidth(12)
    ...
    @ExcelProperty(value = "内网虚拟IP", index = 15)
    @ColumnWidth(18)
    private String virtualServiceIp;

    @ExcelProperty(value = "内网虚拟端口", index = 16)
    @ColumnWidth(12)
    private Integer virtualServicePort;

    @ExcelProperty(value = "内网虚拟协议", index = 17)
    @ColumnWidth(12)
    ...
    @ExcelProperty(value = "外网虚拟IP", index = 19)
    @ColumnWidth(18)
    private String externalVirtualServiceIp;

    @ExcelProperty(value = "外网虚拟端口", index = 20)
    @ColumnWidth(14)
    private Integer externalVirtualServicePort;

    @ExcelProperty(value = "外网虚拟协议", index = 21)
    @ColumnWidth(12)
