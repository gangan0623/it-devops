...
CREATE TABLE IF NOT EXISTS `tb_domain_record` (
  ...
  `external_address` varchar(500) DEFAULT NULL COMMENT '外网访问地址',
...
CREATE TABLE IF NOT EXISTS `tb_domain_delivery` (
  ...
  `load_strategy` varchar(50) DEFAULT NULL COMMENT '负载策略',
  `remark` varchar(500) DEFAULT NULL COMMENT '备注',
  `creator` bigint DEFAULT NULL COMMENT '创建者',
  `create_date` datetime DEFAULT NULL COMMENT '创建时间',
  `updater` bigint DEFAULT NULL COMMENT '更新者',
...
INSERT INTO `sys_menu` VALUES
  (2026032600010000001, 2016426590938480641, '域名记录管理', 'ops/domain-record', NULL, 0, 'icon-file-text', 6, 1067246875800000001, '2026-03-26 09:00:00', 1067246875800000001, '2026-03-26 09:00:00'),
  (2026032600010000002, 2026032600010000001, '查看', NULL, 'ops:domain-record:page,ops:domain-record:info', 1, NULL, 0, 1067246875800000001, '2026-03-26 09:00:00', 1067246875800000001, '2026-03-26 09:00:00'),
  (2026032600010000003, 2026032600010000001, '新增', NULL, 'ops:domain-record:save', 1, NULL, 1, 1067246875800000001, '2026-03-26 09:00:00', 1067246875800000001, '2026-03-26 09:00:00'),
  (2026032600010000004, 2026032600010000001, '修改', NULL, 'ops:domain-record:update', 1, NULL, 2, 1067246875800000001, '2026-03-26 09:00:00', 1067246875800000001, '2026-03-26 09:00:00'),
  (2026032600010000005, 2026032600010000001, '删除', NULL, 'ops:domain-record:delete', 1, NULL, 3, 1067246875800000001, '2026-03-26 09:00:00', 1067246875800000001, '2026-03-26 09:00:00'),
  (2026032600010000006, 2026032600010000001, '历史', NULL, 'ops:domain-record:history', 1, NULL, 4, 1067246875800000001, '2026-03-26 09:00:00', 1067246875800000001, '2026-03-26 09:00:00');
