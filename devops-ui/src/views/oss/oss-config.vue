  ...
  <el-dialog v-model="visible" title="云存储配置" :close-on-click-modal="false" :close-on-press-escape="false">
    <el-form :model="dataForm" :rules="rules" ref="dataFormRef" @keyup.enter="dataFormSubmitHandle()" label-width="140px">
      ...
      <template v-if="dataForm.type === 4">
        <el-form-item prop="minioDomain" label="公开访问地址">
          <el-input v-model="dataForm.minioDomain" placeholder="public-url，例如 https://minioback.leoch.net"></el-input>
        </el-form-item>
        <el-form-item prop="minioPath" label="基础文件夹">
          <el-input v-model="dataForm.minioPath" placeholder="basic-path，例如 /switch"></el-input>
        </el-form-item>
        <el-form-item prop="minioEndPoint" label="接口地址">
          <el-input v-model="dataForm.minioEndPoint" placeholder="endpoint，例如 https://minioback.leoch.net"></el-input>
        </el-form-item>
        <el-form-item prop="minioAccessKey" label="访问密钥">
          <el-input v-model="dataForm.minioAccessKey" placeholder="access-key，例如 admin"></el-input>
        </el-form-item>
        <el-form-item prop="minioSecretKey" label="私有密钥">
          <el-input v-model="dataForm.minioSecretKey" placeholder="secret-key"></el-input>
        </el-form-item>
        <el-form-item prop="minioBucketName" label="存储桶名称">
          <el-input v-model="dataForm.minioBucketName" placeholder="bucket-name，例如 devops"></el-input>
        </el-form-item>
      </template>
      <template v-else-if="dataForm.type === 1">
      ...
      <template v-else-if="dataForm.type === 2">
        <el-form-item prop="aliyunDomain" label="域名">
          <el-input v-model="dataForm.aliyunDomain" placeholder="阿里云绑定的域名，如：http://cdn.devops.io"></el-input>
        </el-form-item>
