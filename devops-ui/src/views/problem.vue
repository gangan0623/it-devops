...
const handleChangeSeverity = () => postAction("severity", { severity: updateForm.targetSeverity, message: updateForm.message }, "严重性已更新");
const handleSuppress = () => postAction("suppress", { days: updateForm.suppressDays, message: updateForm.message }, "抑制已生效");
const handleAck = () => postAction("ack", { message: updateForm.message }, "已确定");
const handleClose = () => postAction("close", { message: updateForm.message }, "已关闭");
